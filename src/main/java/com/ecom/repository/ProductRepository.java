...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	Page<Product> findByisActiveTrueAndTitleContainingIgnoreCaseOrCategoryContainingIgnoreCase(String ch, String ch2,
			...
			Page<Product> findByShopName(String shopName, Pageable pageable);

			Page<Product> findByShopNameAndTitleContainingIgnoreCase(String shopName, String title, Pageable pageable);
}
